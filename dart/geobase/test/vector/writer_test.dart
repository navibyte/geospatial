  ...
  group('Test geometry, coordinate and bounds writers', () {
    test('Projected coordinates', () {
      ...
      _testAllWriters<CoordinateContent>(
        ...
        geoJson: '10.123,20.25,0.0,-1.999',
    ...
    test('PointSeries coordinates', () {
      _testAllWriters<CoordinateContent>(
        ...
        geoJson:
            '[10.123,20.25],[10.123,20.25,-30.95],[10.123,20.25,0.0,-1.999]',
      ...
      _testAllWriters<CoordinateContent>(
        ...
        def: '[10.123,20.25],[10.123,20.25,0.0,-1.999],[10.123,20.25,-30.95]',
        geoJson:
            '[10.123,20.25],[10.123,20.25,0.0,-1.999],[10.123,20.25,-30.95]',
        geoJsonStrict: '[10.123,20.25],[10.123,20.25],[10.123,20.25,-30.95]',
        wktLike: '10.123 20.25,10.123 20.25 0.0 -1.999,10.123 20.25 -30.95',
        wkt: '10.123 20.25,10.123 20.25 0.0 -1.999,10.123 20.25 -30.95',
      );
      _testAllWriters<CoordinateContent>(
        [
          (output) => output.positions([
      ...
      _testAllWriters<CoordinateContent>(
        ...
        geoJson:
            '[10.0,20.0],[11.0,21.0,-30.95,-1.1],[12.0,22.0,0.0,2.2],[13.0,23.0,49.1]',
        geoJsonStrict:
            '[10.0,20.0],[11.0,21.0,-30.95],[12.0,22.0],[13.0,23.0,49.1]',
        wktLike:
            '10.0 20.0,11.0 21.0 -30.95 -1.1,12.0 22.0 0.0 2.2,13.0 23.0 49.1',
        wkt: '10.0 20.0,11.0 21.0 -30.95 -1.1,12.0 22.0 0.0 2.2,13.0 23.0 49.1',
      );
    });
    test('Point geometry', () {
    ...
    test('LineString geometry', () {
      ...
      _testAllWriters<GeometryContent>(
        ...
        def: '[-1.1,-1.1,0.0,0.0],[2.1,-2.5,0.0,4.99],[3.5,-3.49,0.0,0.0]',
        geoJson: '{"type":"LineString",'
            '"bbox":[-1.1,-3.49,0.0,0.0,3.5,-1.1,0.0,4.99],'
            '"coordinates":[[-1.1,-1.1,0.0,0.0],'
            '[2.1,-2.5,0.0,4.99],[3.5,-3.49,0.0,0.0]]}',
