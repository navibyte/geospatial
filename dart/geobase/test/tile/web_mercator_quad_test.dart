  ...
  group('Test WebMercatorQuad', () {
    ...
    test('Test tile bounds', () {
      for (final tileTest in _bounds) {
        ...
        final tile1 = MapPoint2i(zoom: zoom, x: tileX, y: tileY);
        ...
        final tile2 = MapPoint2i(zoom: zoom, x: tileX, y: tmsY);
    ...
    test('Test quad key', () {
      for (final quadTest in _quadkeys) {
        ...
        final tile = MapPoint2i(zoom: zoom, x: tileX, y: tileY);
...
MapPoint2i _refToPixel(Geographic position, int zoom) {
  final world = _refProject(position);
  final scale = 1 << zoom;
  return MapPoint2i(
    zoom: zoom,
...
MapPoint2i _refToTile(Geographic position, int zoom) {
  final world = _refProject(position);
  final scale = 1 << zoom;
  return MapPoint2i(
    zoom: zoom,
