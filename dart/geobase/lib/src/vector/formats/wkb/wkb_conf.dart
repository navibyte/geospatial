...
class WkbConf with EquatableMixin {
  /// Wether geometries decoded and detected as "empty" are built with 
  /// `emptyGeometry` method of content builder.
  /// 
  /// If this is false (as it is by default) geometries detected as "empty" are
  /// build with content methods specific to geometries. For example an empty 
  ...
  @override
  List<Object?> get props => [buildEmptyGeometries];
}
