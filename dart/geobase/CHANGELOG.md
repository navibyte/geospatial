...
NOTE: [geobase version 1.5.0](https://github.com/navibyte/geospatial/milestone/8) currently under development (1.5.0-dev.4).
...
* [Unit conversion extension on num with conversion methods for angle, angular velocity, area, length, speed and time units #267](https://github.com/navibyte/geospatial/issues/267)
